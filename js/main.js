...
(() => {
    const hamburgerBtn = document.querySelector(".hamburger-btn"),
        ...
        colseNavBtn = document.querySelector(".close-nav-menu");

    hamburgerBtn.addEventListener("click", showNavMenu);
    colseNavBtn.addEventListener("click", hideNavMenu);
...
(() => {
    ...
    function popupDetailsToggle() {
        if (projectDetailsContainer.classList.contains("active")) {
            ...
            popup.scrollTo(0, projectDetailsContainer.offset);
        }
    }
})();
...
(() => {
    ...
    // set width of all slider Container
...
/*------Hide all section expect active section------*/
(() => {
